...
namespace BookStoreWebApplication.Controllers
{
    public class OrdersController : Controller
    {
        ...
        {
            var dbbookStoreContext = _context.Orders.Include(o => o.Buyer).Include(o => o.Seller);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,BuyerId,Date,SellerId,Price")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
